...
VALUES
  ...
  ('Bruno','Das Dores','dasdores-bruno@hotmail.com','FNO9NRF1KEO6EHD'),
  ('Carly','de Barros','debarroscarly@bol.com','MLC8TXW8OJF6XVQ'),
...
VALUES
  ...
  ('Dale','Sampaio','s-dale898@outlook.com','EKM4VWH3XSP1CRX'),
  ('Anthony','Andrade','anthony.andrade@bol.com','LTL0FQP3XTH8ACG'),
  ('Leilani','Cruz','leilani.cruz@bol.com','XHJ3RDC3JGI0CTU'),
  ('Oren','dos Santos','dossantos_oren2943@hotmail.com','JWL5NTA8UBA1DHA'),
  ('Whilemina','Soares','w-soares@bol.com','JVL6CPR1PMP8XJU'),
...
VALUES
  ...
  ('Martin','Medeiros','m_medeiros@outlook.com','UHQ8NWY9GTN7YJD'),
  ('Louis','Correia','clouis@gmail.com','WMU4RAM6RKU2GEJ'),
  ('Kasimir','Santiago','kasimir_santiago412@hotmail.com','WBS1UHH8WVL1AHG'),
  ('Charde','Messias','charde-messias@hotmail.com','STI8XEZ1SIZ8XZF'),
  ('Kareem','Bispo','k-bispo@bol.com','DIO9PKC2BEB8KFN'),
...
VALUES
  ...
  ('Maryam','Marques','m-marques6905@gmail.com','CXD7JBM0UMS1ODY'),
  ('Victoria','Pinto','pinto_victoria@bol.com','LBU5BJY2EIO7ZLO'),
  ('Lars','de Lourdes','ldelourdes908@gmail.com','ERI3HKN8HII5ZTP'),
  ('Samuel','Macedo','s.macedo9858@bol.com','UXV8FAQ6BRN8PKU'),
  ('Hilary','Lima','limahilary3815@hotmail.com','IIB5VGM2OWL7CTQ'),
...
VALUES
  ...
  ('Lenore','Franco','f_lenore8371@outlook.com','PFA8QDL1JMK1EFN'),
  ('Ava','de Almeida','dealmeida.ava@outlook.com','XOW2ILE7LNK0POG'),
  ('Minerva','Fagundes','m.fagundes@outlook.com','TRE5WEJ1SMG0FJK'),
  ('Hope','de Azevedo','h-deazevedo4784@outlook.com','JLH3IYQ1MZG6VBR'),
  ('Ignacia','Freire','freire-ignacia6563@bol.com','YVW2DXT7SDG0BEW'),
...
VALUES
  ...
  ('Alexa','Firmino','firmino.alexa@bol.com','FXC7VRF9XCJ0QNE'),
  ('Raja','Paulino','rpaulino@hotmail.com','FXF6MKD3DRN6VLM'),
  ('Patrick','Mariano','p.mariano@outlook.com','OMT5DYY6ZXG1UPQ'),
  ('Nathaniel','Franca','franca.nathaniel3535@gmail.com','CSO8DTG6ZXW7XRQ'),
  ('Abel','Matos','matos-abel4624@gmail.com','ENI8LCL7ITB8OEI'),
...
VALUES
  ...
  ('Ulla','Caetano','c.ulla@gmail.com','QPT5LJQ2PKI8BPV'),
  ('Joel','Moreira','moreira_joel4485@bol.com','HBG3IAK7LZA0SSJ'),
  ('Sydnee','Sousa','ssousa3218@outlook.com','LJH5TWZ5HKE6KJM'),
  ('Christopher','de Carvalho','c_decarvalho@gmail.com','WDO2ESG7VVT5QXP'),
  ('Levi','Pinheiro','l_pinheiro7516@outlook.com','UIN8DVE8IND3QRD'),
...
VALUES
  ...
  ('Cherokee','Felix','fcherokee@bol.com','TSR2NUF7PAH0OSW'),
  ('Beck','Faria','f_beck@bol.com','WEV2OKX3VVG3LOC'),
  ('Nomlanga','Silveira','silveira_nomlanga27@outlook.com','TXJ4RCV3ENF6XKK'),
  ('Ali','Paulino','a-paulino8576@hotmail.com','EUB7THR1FNA5QJM'),
  ('Kato','Vieira','v.kato4814@hotmail.com','DVH5HJK0VPF9DJW'),
...
VALUES
  ...
  ('Alden','Teodoro','alden.teodoro@hotmail.com','WPF1BHU3BBT7KSB'),
  ('Carter','de Moura','demouracarter@bol.com','QJK4DCR6JUS3AEG'),
  ('Jordan','Guedes','j-guedes@bol.com','NCP3BJM7IBF8KXA'),
  ('Peter','Gomes','p.gomes@outlook.com','VEX8ODO0EFB5ECN'),
  ('Ira','Sousa','sousaira55@bol.com','AQV5PZL3GSW1JSV'),
...
VALUES
  ...
  ('Maite','de Paula','maite-depaula2304@outlook.com','KUI1BOB6PQW8KXW'),
  ('Azalia','Mendes','mendesazalia@bol.com','HVR3LUR2BLS1ICW'),
  ('Roary','Santiago','santiagoroary4013@outlook.com','CBK4MVO6MEW5DYC'),
  ('Cole','Nonato','nonatocole@bol.com','LFZ2XAL0REI2THF'),
  ('Jared','Camargo','jared_camargo7259@hotmail.com','BSO6SGH0NMZ6ROD'),
...
VALUES
  ...
  ('Ila','Bastos','bastosila7074@bol.com','RHH2FPO5KIP7VJX'),
  ('Xanthus','da Cruz','dacruz.xanthus7312@outlook.com','VVC1RYH8CBR4IOQ'),
  ('Reece','Soares','r_soares@bol.com','AIT2SJM6GKD4NCQ'),
  ('Alexa','Feitosa','feitosa.alexa9281@bol.com','XXJ3EKG8KFW0HMD'),
  ('Lael','Caetano','caetano_lael1136@hotmail.com','SLG8GOT3XEB4ICX'),
...
VALUES
  ...
  ('Tucker','Sales','sales_tucker5003@gmail.com','LUK5FLU9IXO9RYF'),
  ('Nayda','Gonzaga','n-gonzaga343@outlook.com','OSS7DLF0RIO1OFZ'),
  ('Justin','Freitas','justin-freitas@outlook.com','TCY5OIC3XTT6VWR'),
  ('Gemma','Maia','g-maia@hotmail.com','SIC3ZJC3QTB8PUD'),
  ('Madonna','Cunha','cunha-madonna8760@outlook.com','NHI4WGZ2JHJ3XUZ'),
...
VALUES
  ...
  ('Sopoline','Firmino','sopoline-firmino843@outlook.com','NSB7DDT6ROX1RCY'),
  ('Jade','de Paula','jadedepaula@hotmail.com','JFN8JXT5BLO3HXE'),
  ('Stewart','Aparecido','saparecido6046@bol.com','EQF8RUI6LVH5KWR'),
  ('Cecilia','Ferraz','ferraz.cecilia8862@bol.com','DUF2LIC5GLB7WUO'),
  ('Selma','Araujo','aselma@outlook.com','NFD3CJY5NVE1HYQ'),
...
VALUES
  ...
  ('Todd','Gonçalves','gonalves_todd@hotmail.com','RJC2IUB8SZM4ICP'),
  ('Adara','de Moraes','a_demoraes460@outlook.com','KVU7GCV3ENG9POM'),
  ('Jaquelyn','Torres','torresjaquelyn@outlook.com','NFW8JIN6WYG2GYF'),
  ('Melanie','Neves','melanieneves@gmail.com','TCQ2UOD8GJQ3NRD'),
  ('Armando','do Carmo','a-docarmo3052@hotmail.com','LHF2JMA5VYM0HFL'),
...
VALUES
  ...
  ('Gray','de Assis','deassis-gray@hotmail.com','LEG7LWZ2LLE4GVT'),
  ('Ciara','de Abreu','ciaradeabreu9700@outlook.com','EXY6UCK3JKT8QXM'),
  ('Colleen','de Jesus','d_colleen@gmail.com','UKZ6JEQ2KHN2HDH'),
  ('Christopher','Gomes','christophergomes413@outlook.com','GJN8ETW8GRW6DGX'),
  ('Uriel','Cavalcante','cavalcante.uriel@bol.com','VDI3LQM2LXH7RLD'),
...
VALUES
  ...
  ('Marsden','Araujo','araujo.marsden@hotmail.com','LAI9VHB1EZX6CMK'),
  ('Blake','Lopes','lopes-blake@bol.com','FBM6TQX8RGU4IAS'),
  ('Matthew','Faria','fmatthew@hotmail.com','FCX6SNE4CFX6FTV'),
  ('Elliott','Lima','elliott_lima2760@hotmail.com','GBT1EUX5CHH3ZGO'),
  ('Ezekiel','Silveira','ezekiel-silveira4485@gmail.com','JPF2WTS4HCJ8CGE'),
...
VALUES
  ...
  ('Lars','Aguiar','aguiar.lars4322@bol.com','DRB3UTS3DGM0YRN'),
  ('Amir','Freire','f_amir@bol.com','VOF3UBM3OWO3WRM'),
  ('Connor','Teixeira','tconnor4681@hotmail.com','YZU0LQG0EDD3GQY'),
  ('Lara','Cavalcante','l.cavalcante1213@bol.com','DWK7ZHT1DGI5LSO'),
  ('Cain','Ramos','c_ramos6121@bol.com','RIP7MIV5DSG4VOW'),
...
VALUES
  ...
  ('Lareina','Correa','lareina_correa@hotmail.com','SNU9PGF1XYW6VNQ'),
  ('Connor','de Freitas','c-defreitas3516@outlook.com','WIW2GRE7FUO4MBP'),
  ('Sydnee','Silveira','s.sydnee@gmail.com','KDT6LVZ6YLE8DIM'),
  ('Echo','Martins','martins_echo@outlook.com','CPT0CVV8NRF0LVN'),
  ('Daphne','Mendonca','d_mendonca4997@gmail.com','OYW9HJM9TQK7ODT'),
...
VALUES
  ...
  ('Nathaniel','Pinto','n_pinto@bol.com','PXV7FGH7YWN1HDK'),
  ('Ria','Paulino','p-ria3637@bol.com','DBL6FGN3GGK6YYD'),
  ('Hector','Diniz','h_diniz8271@outlook.com','LKJ8FAB2SLA7BQX'),
  ('Barclay','Antunes','b_antunes@bol.com','POH1TEK7SHF3ITJ'),
  ('Ira','Barboza','barboza.ira@hotmail.com','VCK9EDW1SUJ4WSE'),
...
VALUES
  ...
  ('Guy','Evangelista','guy.evangelista6641@hotmail.com','GVF8TFL4AOI2RAN'),
  ('Martin','de Campos','decampos-martin@bol.com','HUV0XFS3RRE3GUN'),
  ('Brent','do Carmo','d-brent@gmail.com','JYZ1WPG5UQF2HUS'),
  ('Jack','de Souza','desouzajack@hotmail.com','PTF9XMX8EBN7KNW'),
  ('Winifred','Batista','w-batista@outlook.com','KFU5YTL6STV4YFI'),
...
VALUES
  ...
  ('Ryan','Gonçalves','r.gonalves@outlook.com','QPQ8LQE6WUG6QRV'),
  ('Julian','Rodrigues','r.julian@outlook.com','DUQ0CQV7XBK9DLZ'),
  ('Vance','de Melo','v-demelo@hotmail.com','XIX6JUD6AND0MHZ'),
  ('Thaddeus','Aguiar','t.aguiar@gmail.com','NUL3JCX6GAE1XGX'),
  ('Arthur','Costa','arthurcosta5329@bol.com','FTV3RES5NDT3LAU'),
...
VALUES
  ...
  ('Erica','da Rosa','darosa.erica7855@outlook.com','BQV4ROD0LGU2RXE'),
  ('Jonas','Faria','faria_jonas@gmail.com','EFX6SVY5GXP4NDD'),
  ('Blossom','Das Dores','b_dasdores2205@gmail.com','TXI4UBK7ZCV8UFU'),
  ('Lionel','de Carvalho','decarvalho-lionel@bol.com','FDQ6FGW8TGL0JBW'),
  ('Eagan','Camargo','eagan-camargo8871@hotmail.com','FJV3KPN7AHN4RHU'),
...
VALUES
  ...
  ('George','da Cunha','dacunha.george@bol.com','XBW2QQI6MMC8SWS'),
  ('Devin','dos Santos','devin-dossantos@bol.com','WQZ4CWM6TVY2FYX'),
  ('Otto','Macedo','o-macedo9845@bol.com','HPH7TDM5GGF8TNP'),
  ('Neville','Xavier','neville_xavier3369@gmail.com','IDJ2UDC4AST8LGN'),
  ('Drew','de Matos','d.drew@outlook.com','OES5YLG2LQB7GWB'),
...
VALUES
  ...
  ('Thor','Sales','sales.thor9954@gmail.com','OTU9CDP6KFQ5GBD'),
  ('Brenna','Das Chagas','daschagas.brenna5159@gmail.com','VID2FLC2AXH8DME'),
  ('India','Magalhaes','imagalhaes@gmail.com','KCA8KSI4XPV3BFH'),
  ('Noelle','da Rosa','darosanoelle6091@outlook.com','IJQ6XSH8FYV2KLY'),
  ('Hilel','Ferreira','hilelferreira5273@outlook.com','XZE3WCG5BIZ5VEF'),
...
VALUES
  ...
  ('Lysandra','Diniz','lysandra_diniz2064@gmail.com','XTQ0NGE1OSV3BVE'),
  ('Kyle','Domingos','kyle_domingos@gmail.com','ZMK9LRI2DBB7HWX'),
  ('Connor','Sales','sales.connor7728@gmail.com','CWM2TJR5QXR4NHU'),
  ('Macon','Viana','mviana@hotmail.com','WIS7DAN1YVG3WSY'),
  ('Dillon','Ramos','dramos5699@outlook.com','MRP5ARF0HYL8PCN'),
...
VALUES
  ...
  ('Ingrid','de Campos','dingrid3781@gmail.com','UWY0BXB2IOW2NBB'),
  ('Caleb','Messias','c_messias@hotmail.com','JIV3TFF4UXF5GPO'),
  ('Matthew','Fonseca','matthew.fonseca@hotmail.com','IPE7LMY2PMI3GNP'),
  ('Shafira','Caetano','caetano_shafira3584@outlook.com','DXM2WBH0FKW8HUB'),
  ('Freya','Braga','b.freya2066@gmail.com','SHH8HQM4MTR1NNU'),
...
VALUES
  ...
  ('Veda','da Silveira','v-dasilveira@outlook.com','MUT4SUI1CCY3YBI'),
  ('Kelsey','Rosa','k.rosa9519@bol.com','DHL1NBH5XWU0SCG'),
  ('Brandon','de Carvalho','dbrandon8717@hotmail.com','VSX2CXI6GEB6FOU'),
  ('Slade','Pinto','slade-pinto7071@hotmail.com','NLW3GGS8CMO8CZW'),
  ('Hamish','da Rosa','h.darosa1439@outlook.com','LFJ7GYW3DSL4NQO'),
...
VALUES
  ...
  ('Charlotte','Amorim','amorim.charlotte@gmail.com','HAF9KOP8TNQ1RHO'),
  ('Gannon','Cavalcante','gannoncavalcante5984@outlook.com','ISV6WRI8AYS1IJJ'),
  ('Derek','dos Reis','d.dosreis@bol.com','KNP1PVR7KHH0KZK'),
  ('Lillian','Marinho','marinho_lillian@gmail.com','NNH6YUF7ZFT3QJG'),
  ('Beatrice','Nogueira','b_nogueira@outlook.com','MAB1RIP4YPD0DPM'),
...
VALUES
  ...
  ('Carson','Pacheco','pacheco.carson7732@gmail.com','JOD8KCW9YBY9OYQ'),
  ('Calvin','Santana','calvinsantana3155@outlook.com','VYP2MON4LKX9PIY'),
  ('Samson','Borges','samson.borges4116@bol.com','INM3YGE6CNG3HRL'),
  ('Victoria','Ribeiro','v-ribeiro604@gmail.com','SIP1APH1WSS2MRD'),
  ('Demetrius','Batista','demetrius-batista7096@hotmail.com','IZJ7XYK6HXN5ELR'),
...
VALUES
  ...
  ('Lyle','Souza','l.souza2091@outlook.com','RXB2LDQ2VEX0PHM'),
  ('Emerson','Magalhaes','e_magalhaes6799@outlook.com','BWI2GFC5OOG6DXB'),
  ('Christopher','de Paula','depaulachristopher@gmail.com','OEK3SDV3QUP2JAL'),
  ('Sebastian','da Cunha','dacunhasebastian@bol.com','SGI6LBE2IUN3NVW'),
  ('David','Xavier','xdavid@bol.com','TCB7QGV1JUH1XPQ'),
...
VALUES
  ...
  ('Lillith','Silveira','l-silveira@outlook.com','LGH4AKI7WXW8RPY'),
  ('Noelle','Moraes','m_noelle4370@gmail.com','KBS4LVS2SKS4UAK'),
  ('Fredericka','Das Chagas','daschagas-fredericka@outlook.com','TDK7GNT5NYN4NJX'),
  ('Tanisha','Feitosa','feitosa-tanisha@hotmail.com','LEX6DZD3KVO5MFP'),
  ('Garrison','de Sousa','d_garrison9916@bol.com','ZTK2KHE2UIS6XBC'),
...
VALUES
  ...
  ('Amethyst','de Fatima','amethystdefatima@hotmail.com','OVR3JYQ8HTN3PUZ'),
  ('Scott','Domingues','d_scott4298@bol.com','HFY2TKI3VUT7XKD'),
  ('Rinah','Chagas','chagas-rinah6975@bol.com','ERK7QYM9MGR7MQI'),
  ('Allistair','Machado','a_machado@hotmail.com','NIJ0UTC6PNH7LFQ'),
  ('Leroy','Bispo','l_bispo@gmail.com','LZP8OFA0QXT1JGH'),
...
VALUES
  ...
  ('Garrett','Gomes','ggomes@hotmail.com','DYK3IHS1ORY9HWJ'),
  ('Edward','Cabral','e_cabral@bol.com','FMS7BSI8VIH0XIR'),
  ('Kameko','Brito','k_brito8527@outlook.com','OOT6FDF5OZQ4LFB'),
  ('Willa','Barros','barroswilla@gmail.com','NFI8XVA1OUJ8VWN'),
  ('Carol','Domingues','dominguescarol3589@bol.com','VOZ5BIE7KCO6ILE'),
...
VALUES
  ...
  ('Dieter','Lopes','lopes.dieter@gmail.com','SVJ4DEQ1XFF9QOK'),
  ('Kaseem','Bispo','bispo.kaseem7560@outlook.com','JVK1HVX3DAB8QXD'),
  ('Risa','Rodrigues','rodriguesrisa@outlook.com','KBB8BNE8GHF2AQJ'),
  ('Shoshana','Costa','scosta@bol.com','GMM8IGF3KXZ2FVE'),
  ('India','Felix','ifelix9775@gmail.com','MJX3NED7GTL5JJM'),
...
VALUES
  ...
  ('Madaline','Queiroz','madaline-queiroz@bol.com','ANY1EDS3SNJ0JLH'),
  ('Kimberly','Cardoso','c_kimberly@outlook.com','XMD9EAL1FOW5QCJ'),
  ('Reed','Moreira','r.moreira9787@hotmail.com','RWX9LHF6EUM2TNV'),
  ('Ila','Machado','m-ila2557@outlook.com','ZQB2SOY4WPD1YVW'),
  ('Philip','de Jesus','p_dejesus9621@outlook.com','EHU9CVH7IRQ1MRX'),
...
VALUES
  ...
  ('April','Cruz','a-cruz4015@outlook.com','TDB5QMB4YLT4SXL'),
  ('Vielka','dos Santos','dossantos_vielka1815@bol.com','JCP3KLL4UCL6GLE'),
  ('Colby','Furtado','furtado.colby2382@outlook.com','JUY4JNP7AXQ5DER'),
  ('Eagan','Franca','efranca@outlook.com','LFN5ETT1DWL3LAN'),
  ('Dennis','Ramos','r-dennis1571@outlook.com','QZJ2ZUO6HDO1WUI'),
...
VALUES
  ...
  ('Kennedy','Alves','k_alves@bol.com','DIR2FCI1CWU4XDY'),
  ('Norman','Correia','n_correia2563@bol.com','WCF5DML5FJX9TRI'),
  ('Quinlan','Melo','meloquinlan@outlook.com','KET3DNP2OQE2QCS'),
  ('Lana','Ribeiro','ribeiro_lana2502@outlook.com','XUQ9HHW6PUY3RBV'),
  ('Paula','Bueno','bueno_paula2517@gmail.com','MGF2MMA4JMV8IED'),
...
VALUES
  ...
  ('Hu','Cunha','cunha_hu@gmail.com','AQS4LPT1MXY2MBN'),
  ('Henry','Rezende','henry-rezende8192@bol.com','XBS2SKV1TDB1ZMZ'),
  ('Mara','Borges','b_mara9247@gmail.com','YLP2WFN5PEC5WPV'),
  ('Kevin','Barbosa','barbosa_kevin9085@hotmail.com','LGJ2YWY1OUD6EYG'),
  ('Wayne','Mariano','m-wayne582@bol.com','PJB0NOL9YYW0GEG'),
...
VALUES
  ...
  ('Flynn','Dantas','fdantas@bol.com','HAV5GDY3FQY1VRW'),
  ('Phoebe','Silva','s-phoebe8543@hotmail.com','BFK2VIE0FVL5FOU'),
  ('Teagan','dos Reis','t-dosreis8641@bol.com','GBD5RUV3EEG1UBF'),
  ('Austin','Xavier','austin.xavier@outlook.com','YIE6MXI2DTT5KUP'),
  ('Kimberley','de Freitas','d_kimberley@outlook.com','ECZ2GNM7JGH1DWE'),
...
VALUES
  ...
  ('Fleur','Furtado','furtadofleur160@outlook.com','BBQ4FAW9YXE1FIY'),
  ('George','Correia','c-george5434@hotmail.com','CJX2RDM5WUI5RGZ'),
  ('Rose','Melo','r_melo288@gmail.com','GPW3BJP3QTJ3XSQ'),
  ('Katelyn','Alves','k.alves7700@gmail.com','TYC6CXF8SEG6NJT'),
  ('Rhea','da Silva','d-rhea@bol.com','QVZ3MJM4NRK3BFA'),
...
VALUES
  ...
  ('Yoshio','Martins','m_yoshio@hotmail.com','RHJ1LTG0YWI8PMY'),
  ('Ashton','dos Anjos','ashton-dosanjos@hotmail.com','XOC9PVG0REC9HLQ'),
  ('Cally','Domingos','d_cally@bol.com','WIA3FPH8URG1VPP'),
  ('Jennifer','Mota','motajennifer2666@outlook.com','QOM5SFK8XIA6HBQ'),
  ('Xandra','de Oliveira','d-xandra@outlook.com','NSD4OJB8GUF2NTR'),
...
VALUES
  ...
  ('August','Moraes','august.moraes8620@bol.com','XTY4DKF1GJG2DIU'),
  ('Amethyst','de Morais','demorais.amethyst4838@hotmail.com','DCW6CGB9KZK4YDD'),
  ('Lev','de Santana','desantana.lev@hotmail.com','KQR2HWY5HGU9SKK'),
  ('Juliet','Ferreira','ferreira_juliet@bol.com','FXI7XIG7QXY4DYM'),
  ('Lance','Abreu','abreulance@outlook.com','VQO5TRF5HRN3FFN'),
...
VALUES
  ...
  ('Alec','Domingues','domingues-alec31@bol.com','NNA0PIY5NSR8PCV'),
  ('Montana','Bastos','bmontana@outlook.com','ZJK8GMD5TGN5TQX'),
  ('Zachary','Souza','souza.zachary@bol.com','FRV5WBT6CYE7QQG'),
  ('Elton','da Luz','e-daluz@bol.com','YDO2PXP1IWM3RWN'),
  ('Doris','de Morais','doris_demorais8127@outlook.com','GEJ3PFH2JZL4BLY'),
...
VALUES
  ...
  ('Shafira','Teles','teles_shafira@gmail.com','DQE6NRP4DJT1XLI'),
  ('Kelly','Abreu','abreukelly1252@outlook.com','YJF0VOH5IBC8ZBL'),
  ('Britanney','Sales','b_sales8250@gmail.com','LQK9DQW1MHG5SQX'),
  ('Germaine','Silva','g.silva2297@bol.com','TKL7GLX1LRH4VNY'),
  ('Evangeline','Evangelista','e-evangelista529@gmail.com','OQZ7QQY8IUE6LGJ'),
...
VALUES
  ...
  ('Anika','Duarte','duarte_anika@hotmail.com','GHE5DNW3JGU7DTJ'),
  ('Bruce','Silva','bruce.silva@bol.com','ODT8STJ9DNC9CHL'),
  ('Blake','Oliveira','b.oliveira7014@bol.com','HZB5PQW0TEM1NPN'),
  ('Karleigh','de Freitas','kdefreitas5809@gmail.com','HKN4ULK9VPR2FNX'),
  ('Tobias','Araujo','araujotobias4138@gmail.com','KJF3BYK6OBM6DWB'),
...
VALUES
  ...
  ('Catherine','Menezes','catherine-menezes@bol.com','VQQ7LBN6IHF6NBY'),
  ('Dai','Sampaio','dai.sampaio3454@outlook.com','MZZ6DWL4PKS8VUD'),
  ('Rebekah','Trindade','trindaderebekah@outlook.com','JCS5LMU3OMP4KOF'),
  ('Quail','Sampaio','sampaio-quail@hotmail.com','RCD7JCY1LIT2LDX'),
  ('Cadman','de Matos','cadman-dematos4382@hotmail.com','SAI4IFD8MDM6YLY'),
...
VALUES
  ...
  ('Rose','Braz','r-braz@bol.com','CKY1FSH8KRX0DXL'),
  ('Breanna','de Oliveira','b-deoliveira@outlook.com','UEX4OSA1EIN8ZUJ'),
  ('Hayden','Sousa','sousa_hayden987@gmail.com','TAC3ROP1DDK7OSZ'),
  ('Deanna','Ribeiro','d.ribeiro@hotmail.com','YWG2LSD6IVT4UFW'),
  ('Kim','Souza','s_kim2838@hotmail.com','GLI7UYU6HTN6OCV'),
...
VALUES
  ...
  ('Gregory','Henrique','g-henrique@gmail.com','TGO5DYO7WEM5GZN'),
  ('Yvonne','Teixeira','teixeira_yvonne@gmail.com','LOS5BIQ8KGR4TGP'),
  ('Idona','Queiroz','i-queiroz8053@outlook.com','EVD1WED4XUS1QPF'),
  ('Malik','Custodio','c-malik1097@gmail.com','RWC8BSA2LZX1SBF'),
  ('Judith','de Andrade','jdeandrade@outlook.com','NFW6OCA8WKI5HUD'),
...
VALUES
  ...
  ('Odysseus','Garcia','o.garcia@outlook.com','OZX8QWC4XXK3HRM'),
  ('Warren','Pacheco','pacheco.warren@outlook.com','KHX0GTB5BDT6ONT'),
  ('Talon','de Oliveira','t_deoliveira9631@gmail.com','ENM8CGU4ENF3NTX'),
  ('Jacqueline','Castro','j-castro@hotmail.com','GSO3TDE2WBX3GTR'),
  ('Tiger','Costa','tiger-costa5044@outlook.com','DXL3PQS4SYB3DOW'),
...
VALUES
  ...
  ('Leigh','de Lima','delima.leigh6849@gmail.com','MYB2IZC7FWI4TLZ'),
  ('Alden','Tavares','tavares-alden2655@outlook.com','YNW8AVL5GDI7VPN'),
  ('Amir','Moraes','m.amir@outlook.com','KTU2YJD7EIW9KPO'),
  ('Nash','Firmino','nfirmino6948@hotmail.com','MWE6ENR2LSL1ROQ'),
  ('Quyn','Nonato','nonato-quyn@outlook.com','BTI7HGL8KWH0RJM'),
  ('Nevada','Matias','matias.nevada1824@gmail.com','HLL4UYH7STP8SVD'),
  ('Xyla','Leite','leite_xyla1303@bol.com','OVO4CIB2BAP8LNG'),
  ('Chancellor','Teodoro','chancellor_teodoro3207@hotmail.com','RDB3DKZ1CLY8XEL');
